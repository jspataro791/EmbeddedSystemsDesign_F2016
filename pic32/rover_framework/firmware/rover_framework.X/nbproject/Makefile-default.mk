...
${OBJECTDIR}/_ext/1360937237/tsk_lfa_decision.o: ../src/tsk_lfa_decision.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1360937237" 
	@${RM} ${OBJECTDIR}/_ext/1360937237/tsk_lfa_decision.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/tsk_lfa_decision.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/tsk_lfa_decision.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -D__XC -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../../../../framework" -I"../src/system_config/default/framework" -I"../../../../third_party/rtos/FreeRTOS/Source/portable/MPLAB/PIC32MX" -I"../../../../third_party/rtos/FreeRTOS/Source/include" -I"../src/pic32" -MMD -MF "${OBJECTDIR}/_ext/1360937237/tsk_lfa_decision.o.d" -o ${OBJECTDIR}/_ext/1360937237/tsk_lfa_decision.o ../src/tsk_lfa_decision.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
